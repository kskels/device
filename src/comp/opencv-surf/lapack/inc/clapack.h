...
extern "C" {
    ...
    /* Subroutine */
    int dlazq3_(integer *i0, integer *n0, doublereal *z__,
                integer *pp, doublereal *dmin__, doublereal *sigma, doublereal *desig,
                doublereal *qmax, integer *nfail, integer *iter, integer *ndiv,
    ...
    /* Subroutine */
    int dlazq4_(integer *i0, integer *n0, doublereal *z__,
                integer *pp, integer *n0in, doublereal *dmin__, doublereal *dmin1,
                doublereal *dmin2, doublereal *dn, doublereal *dn1, doublereal *dn2,
    ...
    /* Subroutine */
    int dsgesv_(integer *n, integer *nrhs, doublereal *a,
    ...
    /* Subroutine */
    int slacn2_(integer *n, real *v, real *x, integer *isgn,
    ...
    /* Subroutine */
    int slag2d_(integer *m, integer *n, real *sa, integer *ldsa,
                doublereal *a, integer *lda, integer *info);
    ...
    /* Subroutine */
    int slahr2_(integer *n, integer *k, integer *nb, real *a,
    ...
    /* Subroutine */
    int slaqr0_(logical *wantt, logical *wantz, integer *n,
                integer *ilo, integer *ihi, real *h__, integer *ldh, real *wr, real *
    ...
    /* Subroutine */
    int slaqr2_(logical *wantt, logical *wantz, integer *n,
    ...
    /* Subroutine */
    int slaqr3_(logical *wantt, logical *wantz, integer *n,
                integer *ktop, integer *kbot, integer *nw, real *h__, integer *ldh,
                integer *iloz, integer *ihiz, real *z__, integer *ldz, integer *ns,
                integer *nd, real *sr, real *si, real *v, integer *ldv, integer *nh,
                real *t, integer *ldt, integer *nv, real *wv, integer *ldwv, real *
    ...
    /* Subroutine */
    int slaqr4_(logical *wantt, logical *wantz, integer *n,
                integer *ilo, integer *ihi, real *h__, integer *ldh, real *wr, real *
                wi, integer *iloz, integer *ihiz, real *z__, integer *ldz, real *work,
                integer *lwork, integer *info);

    /* Subroutine */
    int slaqr5_(logical *wantt, logical *wantz, integer *kacc22,
    ...
    /* Subroutine */
    int slarrv_(integer *n, real *vl, real *vu, real *d__, real *
    ...
    /* Subroutine */
    int sstemr_(char *jobz, char *range, integer *n, real *d__,
